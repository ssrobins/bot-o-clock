...
def show_next_steps(venv_path):
    ...
    print("\nThen you can:")
    print("\n1. Start bot-o'clock:")
    print("   python bot.py run --mode text")
    print("   python bot.py run --mode voice")
    print("\n2. Check status:")
    print("   python bot.py status")
    print("\n3. List devices:")
    print("   python bot.py devices")
    print("\n4. Create persona:")
    print("   python bot.py create-persona 'MyAgent' --template creative")
    print("\n5. Get help:")
